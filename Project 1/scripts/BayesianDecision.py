...
class DiscriminantAnalysis:
    ...
    def find_accuracy(actual, predicted):
        ...
        return ctr, len(actual) - ctr, (ctr / len(actual)) * 100, 100 - ((ctr / len(actual)) * 100)
    ...
    def predict(self, x_test, y_test):
        ...
        print('Testing dataset using Discriminant Analysis')
        ...
        return self.yhat, self.find_accuracy(y_test, self.yhat)
